...
const VIMT_TENANT = 'xxxxxxxxxx' // Customer VIMT Tenant
const WEBEX_DOMAIN = '@m.webex.com' // VIMT Webex Domain
const SHOW_BUTTON = true; // Display Teams button on Device
const DIALPAD_ID = 'teamsdialpad'; // Dial Pad Identifier
const PANEL_ID = 'teamsjoin'; // Action Button Identifier
...
async function addButton() {
  ...
  console.debug(`Adding Teams Button`);
